 ...
 * city's location.
 */
public class DataPoint extends Geometry {
	/** name of this city */
	...
	public DataPoint(String name, int localX, int localY, int remoteX, int remoteY, int radius, String color) {
		this.name = name;
	...
	public DataPoint(final DataPoint city) {
		this.name = city.name;
