...
public class AvlTree
{
     ...
     */
    private AvlNode remove(City x, AvlNode t )
    {
        if( t == null )
            return t;   // Item not found; do nothing
            
        int compareResult = t.element.getName().compareTo(x.getName());
     ...
     * @throws Exception 
     */
    public City findMin( ) throws Exception
    {
        if( isEmpty( ) )
            throw new Exception( );
     ...
     * @throws Exception 
     */
    public City findMax( ) throws Exception
    {
        if( isEmpty( ) )
            throw new Exception( );
     ...
     */
    public boolean contains( City x )
    {
     ...
     */
    private boolean contains( City x, AvlNode t )
    {
        while( t != null )
        {
            int compareResult = t.element.getName().compareTo(x.getName() );
    ...
    {
        AvlNode( City theElement, AvlNode lt, AvlNode rt )
        {
            element  = theElement;
            left     = lt;
            right    = rt;
    ...
    private void preorder(AvlNode r, Element parentElement)
    {
        if (r != null)
        {
        	...
        	nodeElement.setAttribute("name", (r.element.getName()));
        	nodeElement.setAttribute("radius", Integer.toString( r.element.getRadius()));
